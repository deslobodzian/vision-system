...
class ApriltagDetector {
 public:
  ...
  std::vector<cuAprilTagsID_t> detect_tags(
      const cuAprilTagsImageInput_t& img_input);
  std::vector<cuAprilTagsID_t> detect_april_tags_in_cv_image(
      const cv::Mat& cvImage);
  std::vector<cuAprilTagsID_t> detect_april_tags_in_sl_image(
