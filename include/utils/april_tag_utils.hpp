...
static std::vector<ZedAprilTag> calculate_zed_apriltags(ZedCamera& camera, ApriltagDetector& tag_detector) {

    auto tags = tag_detector.detect_april_tags_in_sl_image(camera.get_left_image());
